  ...
  const navigate = useNavigate();
   const [formdata, setFormData] = useState({
    ...
    const handlesubmit = async(e)=>{
      ...
      {
        console.error("not fetching : ",error.message);
      }

    }
  return (
   <div className='container'>
      <h3 className='text-center mt-3'>Edit Post Employee</h3>
      <Form className='form-group mt-3' onSubmit={handlesubmit}>
        ...
        <Button className="w-100 mt-3" type="submit" variant="primary">Edit Employee</Button>
      </Form>
    </div>
  )
}
